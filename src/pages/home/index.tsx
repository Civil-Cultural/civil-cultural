  ...
  return (
      <Col className="d-flex my-2 px-0 justify-content-around">
          ...
          <Col className="col-3 off-set-4 col-lg-3 d-none d-lg-block">
                              ...
                              >
                                  ...
                                  >
                                      <Link href="#">
                                          ...
                                          >
                                              Elon Musk deixa claro porque
                                              prefere Dogecoin á shiba Inu
                                          </Card.Link>
                                      </Link>
                                  </Card.Title>
                                  <Card.Text
              ...
              <section
                  className={`${styles.sectionCategories} ${styles[theme]}`}
              >
                  ...
                  <Col className="col-11 mx-auto py-2 d-flex flex-wrap gap-1">
                      <span
                          className={`${styles.badgeCategories} ${styles[theme]}`}
                      >
                          <Link href="#">
                              <a
                                  className={`${styles.badgeLink} ${styles[theme]}`}
                              >
                                  Tecnologia
                              </a>
                          </Link>
