...
function Home() {
    ...
    return (
        <Col className="d-flex my-2 px-0 justify-content-around">
                            ...
                            <Row className="col-12">
                                <Col className="col-12 col-md-10 px-0">
                                    <Card.Body className="px-3 px-md-4">
                                        <Card.Text className={`${styles.cardTextDate} ${styles[theme]}`}>
                                            10/05/2021 &#9679; há 4 horas
                                        </Card.Text>
                                        <Card.Title className={styles.cardTitle}>
                                            <Link href="#">
                                                <Card.Link className={styles.cardLink}>
                                                    Caixa Economica divulga calendário de pagamento do Auxílio
                                                    Brasil
                                                </Card.Link>
                                            </Link>
                                        </Card.Title>
                        ...
                        {Array(5)
                            ...
                            .map((x, i) => (
                                <ListGroup.Item key={i} className={styles.listItem}>
                                    ...
                                    >
                                        <Link href="#">
                                            <Card.Link className={`${styles.cardLink} ${styles[theme]}`}>
                                                Elon Musk deixa claro porque prefere Dogecoin á shiba Inu
                                            </Card.Link>
                                        </Link>
                                    </Card.Title>
                                    <Card.Text className={`${styles.cardTextDate} ${styles[theme]}`}>
